"""
TypeScript 타입 정의 생성 스크립트

Pydantic 스키마(canvas.py)를 기반으로 TypeScript 타입 정의 생성

Usage:
    python scripts/generate_types.py

Output:
    backend/types/canvas.ts
"""
...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(__file__), '..', 'types')
    os.makedirs(output_dir, exist_ok=True)

    # Write to file
    output_file = os.path.join(output_dir, 'canvas.ts')
