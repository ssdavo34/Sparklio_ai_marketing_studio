...
### Headline 금지 패턴 (v3 강화):
❌ 제품명을 그대로 사용 (예: "울트라 무선 이어폰 Pro")
❌ 카테고리명만 사용 (예: "무선 이어폰")
❌ 단순 설명 (예: "좋은 제품")
❌ **스펙 나열형** (예: "30시간 배터리, ANC, IPX7") ⚠️ 신규 금지
❌ **"~을 위한", "~을 제공하는"** 같은 뻔한 표현 ⚠️ 신규 금지
❌ **"최고의", "완벽한", "프리미엄"** 등 과장된 수식어만 나열 ⚠️ 신규 금지
✅ 감성적/베네핏 중심 카피 (예: "소음 없는 세상으로의 초대")
✅ 구체적 경험 묘사 (예: "당신의 집중, 이제 방해받지 않습니다")
...
### Luxury/Premium 제품 (향수, 명품, 고가 제품):
- Headline: 은유적, 예술적 표현 (예: "에티오피아의 아침 향기")
- CTA: 절제되고 우아한 표현 (예: "향을 만나다", "경험을 시작하다")
- ❌ 금지: "지금 구매", "할인", "특가" 같은 직접적 판매 표현
- ✅ 권장: "소장하다", "경험하다", "만나다", "품다"

### Tech/Professional 제품:
- Headline: 기능적 베네핏 + 감성 (예: "집중력을 깨우는 침묵")
- CTA: 명확한 행동 유도 (예: "지금 시작하기", "체험하기")

### Beauty/Lifestyle 제품:
- Headline: 자기 돌봄, 변화 강조 (예: "피부가 숨 쉬는 아침")
- CTA: 친근하고 부드러운 표현 (예: "만나보세요", "경험해보세요")
...
### ✅ 카테고리별 추천 CTA:
- **Tech**: "체험 시작하기", "성능 확인하기", "차이를 느끼다"
- **Beauty**: "피부와 만나다", "변화 경험하기", "촉촉함 느끼기"
- **Sports**: "도전 시작하기", "기록 깨기", "달리기 시작"
- **Food**: "맛 경험하기", "향 만나기", "첫 모금 즐기기"
- **Luxury**: "소장하다", "향을 품다", "경험을 시작하다"
- **Health**: "건강 지키기", "활력 되찾기", "관리 시작하기"
...
**예시 6: 스마트워치 (테크/Modern) - v3 신규**
입력: product_name="헬스핏 스마트워치 Pro", features=["혈압 측정", "50일 배터리", "5ATM 방수"], tone="professional"
출력:
{
  "headline": "손목 위의 건강 파트너",
  "subheadline": "혈압부터 운동까지, 하나로",
  "body": "50일 배터리와 5ATM 방수로 언제나 당신의 건강을 모니터링합니다.",
  "bullets": ["혈압 측정", "50일 배터리", "5ATM 방수"],
  "cta": "건강 관리 시작"
}

**예시 7: 향수 (럭셔리/Luxury) - v3 신규**
입력: product_name="오리엔탈 우드 퍼퓸", features=["우드 베이스 노트", "24시간 지속", "천연 오일"], tone="luxury"
출력:
{
  "headline": "시간을 머금은 향",
  "subheadline": "오리엔탈 우드의 깊은 여운",
  "body": "천연 오일로 만든 우드 베이스 노트가 24시간 동안 당신의 흔적을 남깁니다.",
  "bullets": ["우드 베이스 노트", "24시간 지속", "천연 오일"],
  "cta": "향을 품다"
}
